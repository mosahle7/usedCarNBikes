...
//     makeSelectRef.current?.dispatchEvent(new Event('change', { bubbles: true }));
//     modelSelectRef.current?.dispatchEvent(new Event('change', { bubbles: true }));
...
//     Make
//   </Label>
//   <Select ref={(ref) => modelSelectRef.current = ref} className="w-full" id="make">
//     <SelectTrigger>
//       <SelectValue placeholder="Select" />
//     </SelectTrigger>
//     <SelectContent className="bg-white">
//       <SelectItem value="toyota" className="text-black" onClick={handleFilterChange.bind(null,'make', 'Toyota')}>
//         Toyota
//       </SelectItem>
//       <SelectItem value="ford" className="text-black" onClick={handleFilterChange.bind(null,'make', 'Ford')}>
//         Ford
//       </SelectItem>
//       <SelectItem value="honda" className="text-black" onClick={handleFilterChange.bind(null,'make', 'Honda')}>
//         Honda
//       </SelectItem>
//       <SelectItem value="chevrolet" className="text-black" onClick={handleFilterChange.bind(null,'make', 'Chevrolet')}>
//         Chevrolet
//       </SelectItem>
//       <SelectItem value="mercedes" className="text-black" onClick={handleFilterChange.bind(null,'make', 'Mercedes')}>
//         Mercedes
//       </SelectItem>
//     </SelectContent>
//   </Select>
